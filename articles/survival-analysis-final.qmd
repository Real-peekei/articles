...
The model's concordance index comes out at 0.656. ::: {.callout-note title="Why 0.656 isn't a fit problem"}
...
A packaged version of this exact pipeline — unadjusted/adjusted fit, PH test, influence diagnostics, and functional-form checks, returned as a structured verdict table — is available as `fit_coxph_pipeline()` in [`omicsuite`](https://github.com/Real-peekei/omicsuite).
:::
